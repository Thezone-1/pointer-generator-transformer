...
def run_beam_search(sess, model, vocab: data.Vocab, batch: batcher.Batch):
    ...
    while steps < FLAGS.max_dec_steps and len(results) < FLAGS.beam_size:
        ...
        latest_tokens = [
            t if t in range(vocab.size()) else vocab.word2id(data.UNKNOWN_TOKEN) for t in latest_tokens
