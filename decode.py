...
class BeamSearchDecoder:
    ...
    def __init__(self, model: model.SummarizationModel, batcher: batcher.Batcher, vocab: data.Vocab):
        """Initialize decoder.
        ...
        while True:
            ...
            if FLAGS.single_pass:
                ...
                if t1 - t0 > SECS_UNTIL_NEW_CKPT:
                    ...
                    util.load_ckpt(self._saver, self._sess)
                    t0 = time.time()

    def write_for_rouge(self, reference_sents: list[str], decoded_words: list[str], ex_index: int):
    ...
    def write_for_attnvis(self, article: str, abstract: str, decoded_words: list[str], attn_dists, p_gens: list[float | None]):
...
def print_results(article: str, abstract: str, decoded_output: str):
...
def rouge_eval(ref_dir, dec_dir):
    ...
    r.model_dir = ref_dir  # type: ignore
    r.system_dir = dec_dir  # type: ignore
